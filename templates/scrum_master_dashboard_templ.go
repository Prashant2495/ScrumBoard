...
func TeamCapacityCard(userStats []models.UserStats, health models.TeamHealth, sprintName string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, us := range userStats {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/scrum_master_dashboard.templ`, Line: 469, Col: 95}
			}
...
func SprintHistoryCard(history []models.SprintSummary) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, sprint := range history {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/scrum_master_dashboard.templ`, Line: 528, Col: 113}
			}
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if len(blockers) == 0 {
			...
			for _, blocker := range blockers {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/scrum_master_dashboard.templ`, Line: 563, Col: 76}
				}
