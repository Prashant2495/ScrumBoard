...
func Dashboard(data models.DashboardData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div class=\"min-h-screen\"><!-- Header --><header class=\"gradient-bg text-white/90 py-6 px-8 shadow-lg backdrop-blur-sm\"><div class=\"w-full flex items-center justify-between\"><div class=\"flex items-center gap-4\"><div class=\"w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center text-2xl backdrop-blur-md border border-white/20\">🚀</div><div><h1 class=\"text-2xl font-bold text-white/75\">Sprint Dashboard</h1><p class=\"text-white/50 text-sm\">Track sprint progress and team velocity</p></div></div><div class=\"flex items-center gap-4\"><!-- Sprint Selector --><div class=\"glass-dark px-4 py-2 rounded-xl\"><p class=\"text-xs text-white/70 mb-1\">Sprint</p><select id=\"sprint-selector\" class=\"bg-white/10 text-white border border-white/20 rounded-lg px-3 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-white/30\"><option value=\"0\">Loading...</option></select></div><a id=\"jira-sprint-link\" href=\"#\" target=\"_blank\" class=\"bg-blue-500/80 hover:bg-blue-600/90 px-4 py-2 rounded-xl transition-all flex items-center gap-2\" title=\"Open in Jira\"><span>🔗</span> <span>Open in Jira</span></a> <a href=\"/defects\" class=\"bg-white/20 hover:bg-white/30 px-4 py-2 rounded-xl transition-all flex items-center gap-2\"><span>🐛</span> <span>Defects</span></a> <a href=\"/engineer\" class=\"bg-white/20 hover:bg-white/30 px-4 py-2 rounded-xl transition-all flex items-center gap-2\"><span>👨\u200d💻</span> <span>Engineers</span></a></div></div></header><!-- Main Content --><main id=\"dashboard-content\" class=\"w-full px-6 py-8\">")
			if templ_7745c5c3_Err != nil {
